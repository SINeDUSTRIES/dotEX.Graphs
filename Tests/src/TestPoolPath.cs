...
namespace SINeDUSTRIES.Collections.Test
{
  ...
  public class PoolTest : APoolPath<StringWrapper>
  {
    protected override String idRelativeChildGet(StringWrapper child)
    => child.ToString();

    public PoolTest(StringWrapper root, String rootID, Char seperator, IEqualityComparer<String> eqCompGlobal, IEqualityComparer<String> eqCompLocal)
      : base(root, rootID, seperator, eqCompGlobal, eqCompLocal)
    {
    }
  }
